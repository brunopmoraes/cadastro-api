package br.com.lagoinha.certificado;
...
public class PDFTextAdder {
    public static void main(String[] args) {
        String pdfFilePath = "src/main/resources/certificado/start_certificado.pdf"; // Caminho do PDF existente
        String outputFilePath = "src/main/resources/certificado/start_certificado_1.pdf"; // Caminho para o PDF modificado
        String nome = "Rebeca Cristina Sales Souza Moraes"; // O nome que você quer adicionar
        String data = new SimpleDateFormat("dd/MM/yyyy").format(new Date()); // Data atual
        ...
        try {
            ...
            EmailSender.sendEmailWithAttachment("rebeca@souzamoraes.com.br", "Cerficado de Conclusão de Curso", "Corpo do E-mail", outputFilePath);
